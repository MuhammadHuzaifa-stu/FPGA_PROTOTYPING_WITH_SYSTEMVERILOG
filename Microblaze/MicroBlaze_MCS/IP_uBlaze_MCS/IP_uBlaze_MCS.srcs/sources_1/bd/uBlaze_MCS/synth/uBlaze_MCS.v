...
(* CORE_GENERATION_INFO = "uBlaze_MCS,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=uBlaze_MCS,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_board_cnt=2,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "uBlaze_MCS.hwdef" *) 
module uBlaze_MCS
   (IO_0_addr_strobe,
    IO_0_address,
    IO_0_byte_enable,
