...
//--------------------------------------------------------------------------------
//Command: generate_target bd_3802.bd
//Design : bd_3802
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_3802,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_3802,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "uBlaze_MCS_microblaze_mcs_0_0.hwdef" *) 
module bd_3802
   (Clk,
    IO_addr_strobe,
    IO_address,
    ...
    IO_write_strobe,
    Reset);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_ASYNC_RESET Reset, CLK_DOMAIN uBlaze_MCS_clk_in1_0, FREQ_HZ 100000000, PHASE 0.000" *) input Clk;
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > bd_3802 lmb_bram_I" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_3802_dlmb_cntlr_0 dlmb_cntlr
  ...
  bd_3802_ilmb_cntlr_0 ilmb_cntlr
       (.BRAM_Addr_A(ilmb_port_ADDR),
        ...
        .Sl_UE(ilmb_sl_0_UE),
        .Sl_Wait(ilmb_sl_0_WAIT));
  bd_3802_iomodule_0_0 iomodule_0
       (.Clk(Clk1),
  ...
  bd_3802_lmb_bram_I_0 lmb_bram_I
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > bd_3802 dlmb_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_3802_microblaze_I_0 microblaze_I
       (.Byte_Enable(dlmb_BE),
        .Clk(Clk1),
        .DCE(dlmb_CE),
        .DReady(dlmb_READY),
