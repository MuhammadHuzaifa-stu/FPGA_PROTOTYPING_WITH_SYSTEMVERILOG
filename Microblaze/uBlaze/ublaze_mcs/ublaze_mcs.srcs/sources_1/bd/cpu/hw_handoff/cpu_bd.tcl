...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Clk_0_1 [get_bd_ports Clk_0] [get_bd_pins microblaze_mcs_0/Clk]
  connect_bd_net -net Reset_0_1 [get_bd_ports Reset_0] [get_bd_pins microblaze_mcs_0/Reset]
