...
HD_PWD='C:/FPGA_PROTOTYPING/Microblaze/uBlaze/ublaze_mcs/ublaze_mcs.runs/cpu_microblaze_mcs_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_microblaze_mcs_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_microblaze_mcs_0_0.tcl
